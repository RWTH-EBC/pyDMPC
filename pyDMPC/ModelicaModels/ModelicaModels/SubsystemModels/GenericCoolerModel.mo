...
equation
  ...
  connect(supplyPressureDrop.port_b, supplyAirSink.ports[1]) annotation (Line(
        points={{44,0},{52,0},{52,4.44089e-16},{60,4.44089e-16}}, color={0,127,
          255}));
end GenericCoolerModel;
